                        ...
                        <nav class="navbar navbar-expand-lg navbar-light ">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item onlyonmobile">
                                        <a class="nav-link"
                                           href="{{url('/login')}}">ADMIN</a>
                                    </li>
                                    @else
                                    <li class="nav-item onlyonmobile">
                                        <a class="nav-link"
                                           href="{{url('/dashboard')}}">ADMIN</a>
                                    </li>
                                    @endif
                                </ul>
                            </div> <!-- navbar collapse -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                  ...
                  <p style="padding: 1px;">
                        ...
                        <a target="_blank" href="https://www.instagram.com/_Diskode/" class="fa fa-instagram facustom"></a>
                    </div>
                </div>
            </div>
            <div class="mgtop5">
                <p style="text-align: center;padding: 20px;padding-top: 0px">Copyright 2021 @ {{env('APP_NAME')}}. All Rights
                    Reserved</p>
            </div>
